...
* Extra Bases Gained on Basepaths (First to third or home on single, 1st to 2nd on fly ball, 2nd to 3rd on fly ball, 2nd to home on single) DONE
* Double Play Conversion Rates IN PROGRESS
* Inherited Runner Conversion IN PROGRESS
* 1-2-3 Innings IN PROGRESS
...
```{r}
allData <- read.csv('2024 Full MiLB June 4.csv')
