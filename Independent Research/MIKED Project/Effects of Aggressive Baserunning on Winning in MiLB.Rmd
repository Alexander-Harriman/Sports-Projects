...
cleanType <- finalFrame |>
  gt() |>
  tab_header(title = md('**Results of Aggressive Baserunning, 1 Run Games, 2024 MiLB**')) |>
  ...
  tab_footnote(footnote = 'Only Games with a More Aggressive Team Included')
