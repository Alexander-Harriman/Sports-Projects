...
```{r}
#test <- allData |>
#  filter(matchup.pitcher.fullName == 'Rob Zastryzny') |>
#  filter(details.isOut == TRUE)
...
pitcherGame <- allData |>
  ...
  mutate(game_date = ifelse(
    matchup.pitcher.fullName == 'Davis Daniel', '2024-05-03', game_date #Error in data, originally May 4
  )) |>
